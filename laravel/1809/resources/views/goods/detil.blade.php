...
<div>
    <div class="g-pay-lst">
                ...
                <a href="">
                    ...
                    <dl>
                        <dt>
                            ...
                            (第{{$v->goods_id}}潮){{$v->goods_name}}
                        </dt>
                        <dd>总价:<em class="price">{{$v->goods_selfprice*$v->buy_number}}</em>
                                                <em>数量:{{$v->buy_number}}</em>
                                                <em>单价:{{$v->goods_selfprice}}</em>
                        </dd>
                    </dl>
                </a>
            </li>
        ...
        <p class="gray9">总需支付金额：<em class="orange"><i>￥</i></em></p>
    </div>
    ...
    <div class="other_pay marginB">
        ...
        <div class="net-pay">
            <a href="javascript:;" class="checked" id="jdPay" value="1">
                <span class="zfb"></span>
                <b class="z-set"></b>
            </a>
            <a href="javascript:;" id="jdPay" value="2">
                <span class="kq"></span>
                <b class="z-set"></b>
            </a>
        </div>
    ...
    <div class="g-Total-bt">
        <dd><a id="btnPay" href="/weixin/pay/test" class="orangeBtn fr w_account">立即支付</a></dd>
    </div>
